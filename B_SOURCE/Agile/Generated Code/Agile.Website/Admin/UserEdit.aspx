...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:DieRequestDataSource ID="DieRequestDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="UserId" QueryStringField="UserId" /> 
					</Filters>
				</data:SqlParameter>
		...
		<data:DieRequestDataSource ID="DieRequestDataSource2" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="Owner" QueryStringField="UserId" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
		...
		<br />
		<data:EntityGridView ID="GridViewDieRequest3" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewDieRequest3_SelectedIndexChanged"			 			 
			DataSourceID="DieRequestDataSource3"
			DataKeyNames="DieRequestId"
			AllowMultiColumnSorting="false"
			DefaultSortColumnName="" 
			DefaultSortDirection="Ascending"	
		...
		<data:DieRequestDataSource ID="DieRequestDataSource3" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="LastUserUpdate" QueryStringField="UserId" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
		...
		<br />
		<data:EntityGridView ID="GridViewDieRequest4" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewDieRequest4_SelectedIndexChanged"			 			 
			DataSourceID="DieRequestDataSource4"
			DataKeyNames="DieRequestId"
			AllowMultiColumnSorting="false"
			DefaultSortColumnName="" 
			DefaultSortDirection="Ascending"	
		...
		<data:DieRequestDataSource ID="DieRequestDataSource4" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="CodeBy" QueryStringField="UserId" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
