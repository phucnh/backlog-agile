<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DieRequestEdit.aspx.cs" Inherits="DieRequestEdit" Title="DieRequest Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Die Request - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="DieRequestId" runat="server" DataSourceID="DieRequestDataSource">
			...
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DieRequestFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:EntityGridView ID="GridViewDieAttachFile1" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewDieAttachFile1_SelectedIndexChanged"			 			 
			DataSourceID="DieAttachFileDataSource1"
			...
			<EmptyDataTemplate>
				<b>No Die Attach File Found! </b>
				<asp:HyperLink runat="server" ID="hypDieAttachFile" NavigateUrl="~/admin/DieAttachFileEdit.aspx">Add New</asp:HyperLink>
			</EmptyDataTemplate>
		</data:EntityGridView>					
		
		<data:DieAttachFileDataSource ID="DieAttachFileDataSource1" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieAttachFileFilter  Column="DieRequestId" QueryStringField="DieRequestId" /> 
					</Filters>
				</data:SqlParameter>
		...
		<br />
		<data:EntityGridView ID="GridViewDieRequest2" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewDieRequest2_SelectedIndexChanged"			 			 
			DataSourceID="DieRequestDataSource2"
		...
		<data:DieRequestDataSource ID="DieRequestDataSource2" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="ParentDie" QueryStringField="DieRequestId" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
