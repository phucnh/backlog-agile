<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="ResolutionsEdit.aspx.cs" Inherits="ResolutionsEdit" Title="Resolutions Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Resolutions - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="ResolutionsId" runat="server" DataSourceID="ResolutionsDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/ResolutionsFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:ResolutionsDataSource ID="ResolutionsDataSource" runat="server"
			SelectMethod="GetByResolutionsId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="ResolutionsId" QueryStringField="ResolutionsId" Type="String" />
		...
		<data:DieRequestDataSource ID="DieRequestDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="ResolutionsId" QueryStringField="ResolutionsId" /> 
					</Filters>
				</data:SqlParameter>
