<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="MileStoleEdit.aspx.cs" Inherits="MileStoleEdit" Title="MileStole Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Mile Stole - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MileStoleId" runat="server" DataSourceID="MileStoleDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/MileStoleFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:MileStoleDataSource ID="MileStoleDataSource" runat="server"
			SelectMethod="GetByMileStoleId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MileStoleId" QueryStringField="MileStoleId" Type="String" />
		...
		<data:DieRequestDataSource ID="DieRequestDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="MilestoneId" QueryStringField="MileStoleId" /> 
					</Filters>
				</data:SqlParameter>
