<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="PriorityDieRequestEdit.aspx.cs" Inherits="PriorityDieRequestEdit" Title="PriorityDieRequest Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Priority Die Request - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="PriorityDieRequestId" runat="server" DataSourceID="PriorityDieRequestDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/PriorityDieRequestFields.ascx" />
			</EditItemTemplatePaths>
			...
			<EmptyDataTemplate>
				<b>PriorityDieRequest not found!</b>
			</EmptyDataTemplate>
		...
		<data:PriorityDieRequestDataSource ID="PriorityDieRequestDataSource" runat="server"
			SelectMethod="GetByPriorityDieRequestId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="PriorityDieRequestId" QueryStringField="PriorityDieRequestId" Type="String" />
		...
		<data:DieRequestDataSource ID="DieRequestDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="PriorityDieRequestId" QueryStringField="PriorityDieRequestId" /> 
					</Filters>
				</data:SqlParameter>
