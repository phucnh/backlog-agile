<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DieCategoryEdit.aspx.cs" Inherits="DieCategoryEdit" Title="DieCategory Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Die Category - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="DieCategoryId" runat="server" DataSourceID="DieCategoryDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DieCategoryFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:DieCategoryDataSource ID="DieCategoryDataSource" runat="server"
			SelectMethod="GetByDieCategoryId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="DieCategoryId" QueryStringField="DieCategoryId" Type="String" />
		...
		<data:DieRequestDataSource ID="DieRequestDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="DieCategoryId" QueryStringField="DieCategoryId" /> 
					</Filters>
				</data:SqlParameter>
