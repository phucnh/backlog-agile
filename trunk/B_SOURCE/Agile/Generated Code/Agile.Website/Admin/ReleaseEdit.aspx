<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="ReleaseEdit.aspx.cs" Inherits="ReleaseEdit" Title="Release Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Release - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="ReleaseId" runat="server" DataSourceID="ReleaseDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/ReleaseFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:ReleaseDataSource ID="ReleaseDataSource" runat="server"
			SelectMethod="GetByReleaseId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="ReleaseId" QueryStringField="ReleaseId" Type="String" />
		...
		<data:DieRequestDataSource ID="DieRequestDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="CompletedReleaseId" QueryStringField="ReleaseId" /> 
					</Filters>
				</data:SqlParameter>
