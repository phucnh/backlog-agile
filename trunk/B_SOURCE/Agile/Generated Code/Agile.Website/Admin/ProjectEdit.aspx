<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="ProjectEdit.aspx.cs" Inherits="ProjectEdit" Title="Project Edit" %>
		...
		<data:DieRequestDataSource ID="DieRequestDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="ProjectId" QueryStringField="ProjectId" /> 
					</Filters>
				</data:SqlParameter>
