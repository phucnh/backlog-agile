<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DieStatusEdit.aspx.cs" Inherits="DieStatusEdit" Title="DieStatus Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Die Status - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="DieStatus" runat="server" DataSourceID="DieStatusDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DieStatusFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:DieStatusDataSource ID="DieStatusDataSource" runat="server"
			SelectMethod="GetByDieStatus"
		>
			<Parameters>
				<asp:QueryStringParameter Name="DieStatus" QueryStringField="DieStatus" Type="String" />
		...
		<data:DieRequestDataSource ID="DieRequestDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DieRequestFilter  Column="DieStatus" QueryStringField="DieStatus" /> 
					</Filters>
				</data:SqlParameter>
