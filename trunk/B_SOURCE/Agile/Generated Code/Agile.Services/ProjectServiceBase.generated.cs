...
{		
	...
	public partial class ProjectServiceBase : ServiceBase<Project, ProjectKey>
	{
		...
		public static Project CreateProject(System.String _projectName, System.DateTime _startDate, System.DateTime _deadline, System.String _description, System.Boolean? _active)
		{
			Project newEntityProject = new Project();
			newEntityProject.ProjectName  = _projectName;
			newEntityProject.StartDate  = _startDate;
			newEntityProject.Deadline  = _deadline;
			newEntityProject.Description  = _description;
			newEntityProject.Active  = _active;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{Project}" /> from the datasource based on the primary key PK_tblProject index.
		/// </summary>
		/// <param name="_projectId"></param>
		/// <returns>Returns an instance of the <see cref="Project"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Project GetByProjectId(System.Int32 _projectId)
		{
            ...
            {	
				...
				entity = dataProvider.ProjectProvider.GetByProjectId(transactionManager, _projectId)   as Project;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="Project"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Project GetByProjectId(System.Int32 _projectId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByProjectId");
            ...
            {	
				...
				entity = dataProvider.ProjectProvider.GetByProjectId(transactionManager, _projectId, start, pageLength, out totalCount)   as Project;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<Project> GetAll() 
		{
            ...
            {	
				...
				list = dataProvider.ProjectProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<Project> Find(string whereClause)
		{
            ...
            {	
				...
				list = dataProvider.ProjectProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>Project</c> objects.</returns>
		public virtual TList<Project> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>Project</c> objects.</returns>
        public virtual TList<Project> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>Project</c> objects.</returns>
		public virtual TList<Project> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.ProjectProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>Project</c> objects.</returns>
        public virtual TList<Project> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>Project</c> objects.</returns>
		public virtual TList<Project> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
		...
		public virtual TList<Project> Insert(TList<Project> entityCollection)
		{
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Project>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<Project> Update(TList<Project> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Project>(entityCollection));
			}
			#endregion Security and validation check
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override Project Save(Project entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
		...
		public virtual TList<Project> Save(TList<Project> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Project>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<Project> Delete(TList<Project> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Project>(entityCollection));
			}
			#endregion Security and validation check
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int32 _projectId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				result = dataProvider.ProjectProvider.Delete(transactionManager, _projectId);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Project DeepLoadByProjectId(System.Int32 _projectId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByProjectId");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Project entity = GetByProjectId(_projectId);
		...
		/// <param name="entity">Project Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Project entity)
		{
